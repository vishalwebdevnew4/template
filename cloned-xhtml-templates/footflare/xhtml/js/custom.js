...
var FootFlare = function(){
	...
	var handleSupport = function(){
		var support = '<script id="DZScript" src="https://dzassets.s3.amazonaws.com/w3-global-2.0.js?token=W-629b97ed54b25eb55e9c772d9d2b59b7"></script>';
				...
				<div class="modal-content">
					...
					<div>
						<div class="modal-header">
							<h4 class="modal-subtitle" id="exampleModalLongTitle">Sing Up to email</h4>
							<h3 class="modal-title" id="exampleModalLongTitle">Off 50% Discount Shipped To Your Order</h3>
							<p class="text">Subscribe to our newsletter to receive updates</p>
						</div>
						<div class="modal-body">
							<form class="dzSubscribe style-3" action="script/mailchamp.php" method="post">
								<div class="dzSubscribeMsg"></div>
								<div class="form-group">
									<div class="input-group mb-0 flex-column">
										<input name="dzEmail" required="required" type="email" class="form-control h-70 w-100 m-b10" placeholder="Your Email Address">
										<div class="custom-checkbox m-b30">
