var routes = [
  ...
  {
    path: '/recent-job/',
    url: './pages/recent-job.html',
  },
  {
    path: '/apply-job/',
    componentUrl: './pages/apply-job.html',
  },
  {
    path: '/find-job/',
    url: './pages/find-job.html',
  },
  {
    path: '/company/',
    url: './pages/company.html',
  },
  {
    path: '/company-list/',
  ...
  {
    path: '/my-resume/',
    componentUrl: './pages/my-resume.html',
  },
  {
    path: '/create-resume/',
    componentUrl: './pages/create-resume.html',
  },
  {
    path: '/create-resume-2/',
    componentUrl: './pages/create-resume-2.html',
  },
  {
    path: '/messages-list/',
