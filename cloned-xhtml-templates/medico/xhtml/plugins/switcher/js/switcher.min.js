...
$(function(){	
    ...
    jQuery(".skin-1").on('click',function(){
		...
		jQuery(".logo-white img").attr("src", "images/logo-light.png");
        return false;
    });
    ...
    jQuery(".skin-2").on('click',function(){
		...
		jQuery(".logo-white img").attr("src", "images/logo-light2.png");
        return false;
    });
    ...
    jQuery(".skin-3").on('click',function(){
		...
		jQuery(".logo-white img").attr("src", "images/logo-light3.png");
        return false;
    });
    ...
    jQuery(".skin-4").on('click',function(){
		...
		jQuery(".logo-white img").attr("src", "images/logo-light4.png");
        return false;
    });
    ...
    jQuery(".skin-5").on('click',function(){
		...
		jQuery(".logo-white img").attr("src", "images/logo-light5.png");
        return false;
    });	
    ...
    jQuery(".skin-6").on('click',function(){
		...
		jQuery(".logo-white img").attr("src", "images/logo-light6.png");
        return false;
    });		
    ...
    jQuery(".skin-7").on('click',function(){
		...
		jQuery(".logo-white img").attr("src", "images/logo-light7.png");
        return false;
    });
    ...
    jQuery(".skin-8").on('click',function(){
		...
		jQuery(".logo-white img").attr("src", "images/logo-light8.png");
        return false;
    });	
	//=== Color css change function	=====================//	
