		...
		var addCookiesArry = [
			{
				...
				cookiesAdd : [
					...
					},
					{
						...
						value : ".logo-dark img, .logo-white img, .layout-dark .header-nav .logo-dark img",
					},
				]
			},
			{
				...
				cookiesAdd : [
					...
					{
						option : "themeFullColor_logo_image",
						value : "images/logo-2.png, images/logo-white-2.png, images/logo-white-2.png",
					},
					{
						option : "themeFullColor_logo_selector",
						value : ".logo-dark img, .logo-white img, .layout-dark .header-nav .logo-dark img",
