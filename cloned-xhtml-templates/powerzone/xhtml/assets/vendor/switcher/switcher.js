...
var dzSwitcher = '<div class=styleswitcher id=dzSwitcher-right><div class=overlay-switch></div><div class=switcher-btn-bx><a class="closed switch-btn"href=javascript:void(0);><span class="fa-cog fas"></span></a></div><div class=styleswitcher-inner><div class=sw-main-title><a class="btn btn-primary btn-sm btn-tooltip dez-page"href=javascript:void(0); onclick=deleteAllCookie()><i class="fa-regular fa-trash-can"></i><span class=tooltip-text>Delete All Cookie</span></a></div><div class="row theme-design"><div class="col-md-12 theme-box"><ul class="color-skins theme-panel-save"val=themeFullColor><li class=active><a class="theme-color theme-skin skin-1"href=javascript:void(0); data-color-theme=skin-1 data-logo-image="assets/images/logo.png, assets/images/logo-white.png, assets/images/logo-white.png"data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header-nav .logo-dark img"></a><li><a class="theme-color theme-skin skin-2"href=javascript:void(0); data-color-theme=skin-2 data-logo-image="assets/images/logo-2.png, assets/images/logo-white-2.png, assets/images/logo-white-2.png"data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header-nav .logo-dark img"></a><li><a class="theme-color theme-skin skin-3"href=javascript:void(0); data-color-theme=skin-3 data-logo-image="assets/images/logo-3.png, assets/images/logo-white-3.png, assets/images/logo-white-3.png"data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header-nav .logo-dark img"></a><li><a class="theme-color theme-skin skin-4"href=javascript:void(0); data-color-theme=skin-4 data-logo-image="assets/images/logo-4.png, assets/images/logo-white-4.png, assets/images/logo-white-4.png"data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header-nav .logo-dark img"></a><li><a class="theme-color theme-skin skin-5"href=javascript:void(0); data-color-theme=skin-5 data-logo-image="assets/images/logo-5.png, assets/images/logo-white-5.png, assets/images/logo-white-5.png"data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header-nav .logo-dark img"></a><li><a class="theme-color theme-skin skin-6"href=javascript:void(0); data-color-theme=skin-6 data-logo-image="assets/images/logo-6.png, assets/images/logo-white-6.png, assets/images/logo-white-6.png"data-logo-selector=".logo-dark img, .logo-white img, .layout-dark .header-nav .logo-dark img"></a></ul></div></div></div></div>';	
