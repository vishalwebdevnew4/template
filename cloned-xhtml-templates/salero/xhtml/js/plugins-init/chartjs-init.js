 ...
 var dlabSparkLine = function(){
					...
					datasets: [
						{
							...
							borderWidth: "0",
							colors: '#fff',
							backgroundColor: 'rgba(12,20,254,1)'
						}
					]
				},
				options: {
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(248,185,64,1)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(248,185,64,1)");
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(248,185,64,1)");
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(248,185,64,1)");
	...
	var areaChart2 = function(){	
		...
		if(jQuery('#areaChart_2').length > 0 ){
			...
			areaChart_2gradientStroke.addColorStop(0, "rgba(12, 20, 254, 0.2)");
			areaChart_2gradientStroke.addColorStop(1, "rgba(12, 20, 254, 0)");
