 ...
 var dzSparkLine = function(){
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(234, 122, 154, 1)");
			barChart_3gradientStroke.addColorStop(1, "rgba(234, 122, 154, 0.5)");
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			//lineChart_2gradientStroke.addColorStop(0, "rgba(255, 114, 13, 1)");
			//lineChart_2gradientStroke.addColorStop(1, "rgba(255, 114, 13, 0.5)");
			//
			//Chart.controllers.line = Chart.controllers.line.extend({
			//	draw: function () {
			//		draw.apply(this, arguments);
			...
			//generate gradient
			const lineChart_2gradientStroke = lineChart_2.createLinearGradient(500, 0, 100, 0);
			lineChart_2gradientStroke.addColorStop(0, "rgba(234, 122, 154, 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(234, 122, 154, 0.5)");
					...
					datasets: [
						{
							...
							tension:0.5,
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(234, 122, 154, 0.5)'
						}
					]
				},
				options: {
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			//generate gradient
			const lineChart_3gradientStroke1 = lineChart_3.createLinearGradient(500, 0, 100, 0);
			lineChart_3gradientStroke1.addColorStop(0, "rgba(234, 122, 154, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(234, 122, 154, 0.5)");
					...
					datasets: [
						{
							...
							tension:0.5,
							fill:true,
							backgroundColor: 'rgba(234, 122, 154, .5)', 
