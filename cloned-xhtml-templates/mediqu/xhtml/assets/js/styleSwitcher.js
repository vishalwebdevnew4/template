...
function addSwitcher(){
    ...
    <div class="sidebar-right-inner">
        ...
        <div class="tab-content tab-content-default tabcontent-border">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div>
								...
								<span>
									<input class="chk-col-primary filled-in" id="primary_color_15" name="primary_bg" type="radio" value="color_15">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div>
								...
								<span>
									<input class="chk-col-primary filled-in" id="nav_header_color_15" name="navigation_header" type="radio" value="color_15">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div>
								...
								<span>
									<input class="chk-col-primary filled-in" id="header_color_15" name="header_bg" type="radio" value="color_15">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div>
								...
								<span>
									<input class="chk-col-primary filled-in" id="sidebar_color_15" name="sidebar_bg" type="radio" value="color_15">
            ...
            <div class="note-text">
				<span class="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="https://coreui.w3itexperts.com/?theme=Mediqu" target="_blank">documentation.</a>
			</div>
        </div>
	</div>
</div>`;
    ...
    <div class="dz-demo-inner">
        ...
        <div class="fs-14 pt-3">
			<span class="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="https://coreui.w3itexperts.com/?theme=Mediqu" target="_blank" class="text-primary">documentation.</a>
		</div>
    </div>
</div>`;
