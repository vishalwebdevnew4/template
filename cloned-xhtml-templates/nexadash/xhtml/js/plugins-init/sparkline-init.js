	...
	var sparkLine8 = function(){
		if(jQuery('#sparkline8').length > 0 ){	
			$("#sparkline8").sparkline([79, 72, 29, 6, 52, 32, 73, 40, 14, 75, 77, 39, 9, 15, 10], {
				...
				height: "50",
				lineColor: "#1d69d6",
				fillColor: "rgba(29, 105, 214,1)",
				minSpotColor: "#1d69d6",
				maxSpotColor: "#1d69d6",
				highlightLineColor: "#1d69d6",
				highlightSpotColor: "#1d69d6",
		...
		if(jQuery('#StackedBarChart').length > 0 ){	
			$('#StackedBarChart').sparkline([
				...
				[4, 1, 2]
					...
					barWidth: 10,
					barSpacing: 7, 
					stackedBarColor: ['#1d69d6', '#ffdede', '#ff5c00']
				});
		}
	}
