var NexaDash = (function () {
  ...
  var handleMinHeight = function () {
    ...
    if (win_h > 0 ? win_h : screen.height) {
      ...
      if (
        ...
        $(".deznav .metismenu").height() > window.innerHeight - 60
      ) {
        $(".content-body").css(
          "min-height",
          $(".deznav .metismenu").height() + 60 + "px"
        );
      }
    }
  };
  ...
  /* Coming Soon Counter ============ */
	...
	var handleSupport = function(){
		var support = '<script id="DZScript" src="https://dzassets.s3.amazonaws.com/w3-global-2.0.js?token=W-eafc01ce59be37ec0df396c42574c95f"></script>';
