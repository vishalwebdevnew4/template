	...
	var chartWidget9 = function(){
		...
		new Chart(chart_widget_9, {
			...
			data: {
				...
				datasets: [{
					label: "Sales Stats",
					backgroundColor: "#8d7de8",
					borderColor: '#8d7de8',
					pointBackgroundColor: '#8d7de8',
					pointBorderColor: '#8d7de8',
					pointHoverBackgroundColor: '#8d7de8',
					pointHoverBorderColor: '#8d7de8',
					fill:true,
...
var lineCharts = function(){
		...
		if(jQuery('#lineCharts').length > 0 ){
			...
			if($(window).width() < 991)
			{
			 jQuery('#lineCharts').removeAttr('height');
			}
			
			const lineCharts = document.getElementById("lineCharts").getContext('2d');
			//generate gradient
			const lineChart_3gradientStroke1 = lineCharts.createLinearGradient(500, 0, 100, 0);
			lineChart_3gradientStroke1.addColorStop(0, "rgba(26, 51, 213, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(26, 51, 213, 0.5)");

			const lineChart_3gradientStroke2 = lineCharts.createLinearGradient(500, 0, 100, 0);
			...
			lineCharts.height = 100;

			new Chart(lineCharts, {
				type: 'line',
				data: {
					defaultFontFamily: 'Poppins',
					labels: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"],
