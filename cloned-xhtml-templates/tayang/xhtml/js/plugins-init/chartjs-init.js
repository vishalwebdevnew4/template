 ...
 var dzSparkLine = function(){
					...
					datasets: [
						{
							...
							borderColor: 'rgba(141, 125, 232, 1)',
							borderWidth: "0",
							barThickness:40,
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(141, 125, 232, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(141, 125, 232, 0.5)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(141, 125, 232, 1)");
			barChart_3gradientStroke.addColorStop(1, "rgba(141, 125, 232, 0.5)");
			...
			const lineChart_1 = document.getElementById("lineChart_1").getContext('2d');
			 class Custom extends Chart.LineController {
				draw() {
					...
					ctx.stroke = function(){
						ctx.save();
						ctx.shadowColor = 'rgba(141, 125, 232, 0.1)';
						ctx.shadowBlur = 10;
						ctx.shadowOffsetX = 0;
						ctx.shadowOffsetY = 4;
					...
					datasets: [
						{
							...
							tension:0.5,
							//fill:true,
							pointBackgroundColor: 'rgba(141, 125, 232, 1)'
						}
					]
				},
				options: {
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(141, 125, 232, 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(141, 125, 232, 0.5)");
			...
			class Custom extends Chart.LineController {
				draw() {
					...
					ctx.stroke = function(){
						ctx.save();
						ctx.shadowColor = 'rgba(141, 125, 232, 0.2)';
						ctx.shadowBlur = 10;
						ctx.shadowOffsetX = 0;
						ctx.shadowOffsetY = 4;
						_stroke.apply(this, arguments);
					...
					datasets: [
						{
							...
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(141, 125, 232, 0.5)',
							tension:0.5,
						}
					]
				},
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(141, 125, 232, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(141, 125, 232, 0.5)");
					...
					datasets: [
						{
							...
							borderWidth: "1",
							backgroundColor: 'rgba(141, 125, 232, .5)', 
