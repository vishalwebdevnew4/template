(function($) {
   ...
   var dzChartJs = function(){
	  ...
	  var barChart2 = function(){
		  ...
		  //gradient bar chart
			  ...
			  barChart_2gradientStroke.addColorStop(0, "rgba(82, 177, 65, 1)");
			  barChart_2gradientStroke.addColorStop(1, "rgba(82, 177, 65, 0.5)");
	  ...
	  var barChart3 = function(){
		  ...
		  if(jQuery('#barChart_3').length > 0 ){
			  ...
			  barChart_3gradientStroke.addColorStop(0, "rgba(82, 177, 65, 1)");
			  barChart_3gradientStroke.addColorStop(1, "rgba(82, 177, 65, 0.5)");
  
			  const barChart_3gradientStroke2 = barChart_3.createLinearGradient(50, 100, 50, 50);
			  barChart_3gradientStroke2.addColorStop(0, "rgba(86, 199, 206, 1)");
			  barChart_3gradientStroke2.addColorStop(1, "rgba(86, 199, 206, 1)");
  
			  const barChart_3gradientStroke3 = barChart_3.createLinearGradient(50, 100, 50, 50);
			  barChart_3gradientStroke3.addColorStop(0, "rgba(255, 40, 92, 1)");
			  barChart_3gradientStroke3.addColorStop(1, "rgba(255, 40, 92, 1)");
		  ...
		  //basic line chart
			  ...
			  class Custom extends Chart.LineController {
				  draw() {
					  ...
					  ctx.stroke = function(){
						  ctx.save();
						  ctx.shadowColor = 'rgba(69, 11, 90, 0.1)';
						  ctx.shadowBlur = 10;
						  ctx.shadowOffsetX = 0;
						  ctx.shadowOffsetY = 4;
					  ...
					  datasets: [
						  {
							  ...
							  pointBackgroundColor: 'rgba(82, 177, 65, 1)',
							  tension:0.5,
						  }
					  ]
				  },
	  ...
	  var lineChart2 = function(){
		  ...
		  if(jQuery('#lineChart_2').length > 0 ){
			  ...
			  lineChart_2gradientStroke.addColorStop(0, "rgba(82, 177, 65, 1)");
			  lineChart_2gradientStroke.addColorStop(1, "rgba(82, 177, 65, 0.5)");
			  class Custom extends Chart.LineController {
				  draw() {
					  // Call bubble controller method to draw all the points
					  super.draw(arguments);	
					  ...
					  datasets: [
						  {
							  ...
							  backgroundColor: 'transparent', 
							  tension:0.5,
							  pointBackgroundColor: 'rgba(82, 177, 65, 0.5)'
						  }
					  ]
				  },
				  options: {
	  ...
	  var lineChart3 = function(){
		  ...
		  if(jQuery('#lineChart_3').length > 0 ){
			  ...
			  lineChart_3gradientStroke1.addColorStop(0, "rgba(82, 177, 65, 1)");
				lineChart_3gradientStroke1.addColorStop(1, "rgba(82, 177, 65, 0.5)");
  
			  const lineChart_3gradientStroke2 = lineChart_3.createLinearGradient(500, 0, 100, 0);
			  lineChart_3gradientStroke2.addColorStop(0, "rgba(255, 109, 77, 1)");
				lineChart_3gradientStroke2.addColorStop(1, "rgba(255, 109, 77, 1)");
					  ...
					  datasets: [
						  {
							  ...
							  borderWidth: "1",
							  backgroundColor: 'rgba(82, 177, 65, .5)', 
  ...
  jQuery(window).on('resize',function(){
	  //dzChartJs.resize();
	  setTimeout(function(){ dzChartJs.resize(); }, 200);
  });
