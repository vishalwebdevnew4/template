...
var GardenZone = function(){
	...
	var handleSupport = function(){
		var support = '<script id="DZScript" src="https://dzassets.s3.amazonaws.com/w3-global-2.0.js?token=W-7e51746feafa7f2621f71943da8f603c"></script>';
		jQuery('body').append(support);
	}
	
	var handleContactPopup = function(){
		var popup = '<div class="contant-no-area"><div class="contact-number"><h5>Have A Questions</h5><h6>0800 987654320</h6></div><div class="contact-pic"><img src="images/testimonials/pic4.jpg" alt=""></div><div class="contact-name"><span>Jone Cane</span></div><!-- Go to www.addthis.com/dashboard to customize your tools --><script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"></script>';
