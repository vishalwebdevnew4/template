 ...
 var dzChartJs = function(){
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(19, 98, 252, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(19, 98, 252, 0.5)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(19, 98, 252, 1)");
			barChart_3gradientStroke.addColorStop(1, "rgba(19, 98, 252, 0.5)");
		...
		//basic line chart
			...
			class Custom extends Chart.LineController {
				draw() {
					...
					ctx.stroke = function(){
						ctx.save();
						ctx.shadowColor = 'rgba(19, 98, 252, 0.1)';
						ctx.shadowBlur = 10;
						ctx.shadowOffsetX = 0;
						ctx.shadowOffsetY = 4;
					...
					datasets: [
						{
							...
							pointBackgroundColor: 'rgba(19, 98, 252, 1)',
							tension:0.5,
						}
					]
				},
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(19, 98, 252, 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(19, 98, 252, 0.5)");
					...
					datasets: [
						{
							...
							backgroundColor: 'transparent', 
							tension:0.5,
							pointBackgroundColor: 'rgba(19, 98, 252, 0.5)'
						}
					]
				},
				options: {
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(19, 98, 252, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(19, 98, 252, 0.5)");
					...
					datasets: [
						{
							...
							borderWidth: "1",
							backgroundColor: 'rgba(19, 98, 252, .5)', 
							tension:0.5,
							fill:true,
